function feature_table_all = extractFeaturesSignal(signal, fs, window_length, window_overlap)


%new version of extractFeatures to extract features from a signal
